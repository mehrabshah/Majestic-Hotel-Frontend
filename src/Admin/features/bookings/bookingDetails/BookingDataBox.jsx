        ...
        <div className="row mt-10">
          <div className="flex flex-row mt-4">
            ...
            <div className="flex flex-col justify-between px-5">
              <span>Check-in:</span>
              <span className="font-bold">{extractLocalDate(booking.categories[0].bookingDetails[0].startDate)}</span>
            </div>
            <div className="flex flex-col justify-between px-5">
              <span>Checkout:</span>
              <span className="font-bold">{extractLocalDate(booking.categories[0].bookingDetails[0].endDate)}</span>
            </div>
          </div>
        </div>
