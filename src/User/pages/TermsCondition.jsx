  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <p className="mb-6">
          Welcome to The Horizon Hotel. We're delighted to have you as our
        ...
        <p className="mb-6">
          The Horizon Hotel reserves the right to update or modify these terms
          and conditions at any time without prior notice. Any changes will be
          effective immediately upon posting on our website.
        </p>

        <p className="mb-6">
          By making a reservation at The Horizon Hotel, you agree to abide by
          ...
          . Thank you for choosing The Horizon Hotel for your stay. We look
